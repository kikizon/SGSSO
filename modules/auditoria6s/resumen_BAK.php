  ...
  <div class="card-body">
    <div class="row align-items-center">
      ...
      <div class="col-md-3 text-md-center mt-2 mt-md-0">
        <div class="small text-muted">Calificación de la sucursal</div>
        <div class="display-6"><span class="badge bg-<?= color_6s($kpi['prom']) ?>"><?= $kpi['prom'] !== null ? $kpi['prom'].'%' : '—' ?></span></div>
      </div>
      <div class="col-md-3 text-md-center mt-2 mt-md-0">
        <div class="small text-muted">Auditorías finalizadas</div>
