...
exigir('incapacidades.tramo.agregar');
...
// Documento obligatorio (validación por MIME real)
...
if (!move_uploaded_file($_FILES['documento']['tmp_name'], UPLOAD_DIR . $nombreArchivo)) {
