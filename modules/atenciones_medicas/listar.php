...
$sql = "SELECT * FROM atenciones_medicas $whereEstado ORDER BY descripcion";
...
<h2><i class="fas fa-hospital"></i> Catálogo de Atenciones Médicas</h2>
<a href="crear.php" class="btn btn-primary mb-3"><i class="fas fa-plus"></i> Nueva Atención Médica</a>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="eliminar.php?id=<?= $a['id'] ?>" class="btn btn-sm btn-danger" onclick="return confirm('¿Eliminar este registro?')"><i class="fas fa-trash"></i></a>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
