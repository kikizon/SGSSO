...
<?php else: ?>
    ...
    <?php if ($tipo_filtro == 'accidente'): ?>
        ...
        <div class="col-md-2"><div class="card bg-dark text-white h-100 kpi-card"><div class="card-body"><h6 class="card-title">Tasa Frec. <i class="fas fa-info-circle" data-bs-toggle="tooltip" title="Tasa de Frecuencia (mes actual)"></i></h6><h2 class="display-6"><?= $tasaFrecuencia ?></h2></div></div></div>
        <div class="col-md-2"><div class="card bg-secondary text-white h-100 kpi-card"><div class="card-body"><h6 class="card-title">Tasa Gravedad <i class="fas fa-info-circle" data-bs-toggle="tooltip" title="Tasa de Gravedad (mes actual)"></i></h6><h2 class="display-6"><?= $tasaGravedad ?></h2></div></div></div>
